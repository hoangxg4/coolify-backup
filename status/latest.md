...
| | |
|---|---|
| **Run** | #193 (id `34962422576`) |
| **Trigger** | scheduled (every 6h) |
| **Started** | 2026-09-15T11:16:43Z |
| **Duration** | 10m 59s |
...
- **Upload failed**: 0
- **Cleanup**: 93 server dir(s) scanned, 54 old backup(s) deleted
...
| Host | Reason |
|---|---|
| 185.222.242.202 | data/coolify missing, volumes only |
