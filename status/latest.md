...
| | |
|---|---|
| **Run** | #143 (id `33654805535`) |
| **Trigger** | scheduled (every 6h) |
| **Started** | 2026-09-02T16:25:19Z |
| **Duration** | 9m 56s |
| **Result** | :warning: PARTIAL |

## Summary

- **Servers**: 88 (in 10 batch(es))
- **Backup OK**: 56
- **Failed**: 32
- **Partial (data/coolify missing, volumes only)**: 0
- **Upload failed**: 0
- **Cleanup**: 89 server dir(s) scanned, 56 old backup(s) deleted
...
| 176.9.89.217 | backup failed (ssh rc=124) |
